    ...
    <div class="space-y-2 rounded-2xl bg-base-100 p-6 shadow-lg md:my-0">
        ...
        <div class="flex items-center space-x-5">
            ...
            <div class="flex flex-col space-y-1">
                ...
                <p class="text-sm text-accent">{{ $article->user->bio }}</p>
...
<x-slot name="rightSidebar">
    <div class="space-y-3">
        ...
        @if ($article->series)
            <div class="space-y-2 rounded-2xl bg-base-100 p-6 shadow-lg">
                ...
                <ul class="space-y-1">
                    @foreach ($article->series->articles()->get() as $seriesArticle)
                        <li class="items-center space-x-1">
                            <a class="@if (request()->segment(2) == $seriesArticle->slug) font-bold ml-1 @endif link link-accent no-underline"
        ...
        <div class="rounded-2xl bg-base-100 p-6 shadow-lg md:my-0">
            <div class="mb-2 text-3xl font-bold">Most Viewed</div>
            <div class="items-center space-y-2">
                @foreach ($populars as $popular)
                    <div class="card flex flex-row items-center space-x-1">
                        ...
                        <div class="w-3/4">
                            <a class="link link-accent font-semibold no-underline transition duration-500 hover:scale-110"
...
<div class="space-y-4">
    <div class="rounded-2xl bg-base-100 px-8 py-8 shadow-lg md:px-0">
        ...
        <article
            class="prose mx-auto break-words prose-a:link-accent md:prose-lg prose-a:no-underline prose-code:rounded-2xl prose-code:p-1 prose-code:font-normal prose-li:m-0 prose-img:rounded-2xl prose-img:shadow-lg md:order-2">
            <h1>{{ $article->title }}</h1>
            ...
            <div class="col-span-full md:col-span-1">
                @if ($seriesEpisode['prev'])
                    <div class="flex flex-col items-start justify-start rounded-2xl bg-base-100 p-4 shadow-lg">
                        ...
                        <a class="link link-accent cursor-pointer text-sm font-bold no-underline"
